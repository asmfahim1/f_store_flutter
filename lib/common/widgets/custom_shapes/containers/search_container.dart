...
class FSearchContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(padding: const EdgeInsets.symmetric(horizontal: FSizes.defaultSpace), child: Container(
      ...
      child: Row(
        children: [
          ...
          Text(text, style: Theme.of(context).textTheme.bodySmall!.apply(color: FColors.darkGrey),)
        ],
      ),
    ),);
  }
